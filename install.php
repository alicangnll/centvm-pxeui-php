...
switch ($sayfa) {
  ...
  break;
	...
	<b>Lütfen bu komutları öncelikli olarak girin</b><br>';
echo "<pre>
...
if (!function_exists('shell_exec')) {
  ...
  <input type="text" class="form-control" name="lang" id="lang" placeholder="TR/EN"><br>
  <input type="password" class="form-control" name="rootpwd" id="rootpwd" placeholder="Root Password"><br>';
echo '<select data-role="select" id="netwdrv" name="netwdrv">';
$array = array();
...
$conn2 = new mysqli($mysqlserv, $mysqlusr, $mysqlpass, $mysqldb);
...
$admincreate = "CREATE TABLE `admin_list` (
...
if ($conn2->query($admincreate) === TRUE) {
} else {
die('<body class="container">
<br><br><br>
<div class="mx-auto card">
...
$createmenu = "CREATE TABLE `boot_menu` (
...
if ($conn2->query($createmenu) === TRUE) {
} else {
die('<body class="container">
<br><br><br>
<div class="mx-auto card">
...
$insertadmin = "INSERT INTO `admin_list` (`admin_id`, `admin_email`, `admin_usrname`, `admin_passwd`, `admin_token`, `admin_yetki`) VALUES
(1, 'alicangonullu@yahoo.com', 'alicangonullu', '63982e54a7aeb0d89910475ba6dbd3ca6dd4e5a1', '63982e54a7aeb0d89910475ba6dbd3ca6dd4e5a1', '1');";

if ($conn2->query($insertadmin) === TRUE) {
} else {
die('<body class="container">
<br><br><br>
<div class="mx-auto card">
...
$alters2 = "ALTER TABLE `boot_menu`
  MODIFY `boot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;";
...
$str3 = str_replace("System", "", $str2);
  ...
  <div class="form-group">
  <br><br><a href="install.php?git=install" " class="btn btn-dark">İleri / Next</button><br>
  </div></div></div></body>';
	break;
  ...
  case 'install':
	...
	$str2 = str_replace(":", "", $str1);
	$str3 = str_replace("System", "", $str2);
  if(strip_tags(trim($str3)) == "Ubuntu 20.04.1 LTS") {
...
<p>Yükleme Tamamlandı. Artık Server hazır durumdadır.</p>
	...
	HDD Image Create Code : qemu-img create -f raw /var/lib/tftpboot/data/iso/disk1.img 10G <br>
	HDD Image Info Code : qemu-img info /var/lib/tftpboot/data/iso/disk1.img <br>
	HDD Image Resize Code : qemu-img resize -f raw /var/lib/tftpboot/data/iso/disk1.img 20G</br>
	<br>
Perm Problem Solve :	<br>
